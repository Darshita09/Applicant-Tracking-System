...
@Component({
  selector: 'app-disapprovedcandidate',
  templateUrl: './disapprovedcandidate.component.html',
  styleUrls: ['./disapprovedcandidate.component.css']
})
export class DisapprovedcandidateComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._candidateser.GetRejectedCandidate(this.fk_Recruiter_id).subscribe(
      (data:CandidateJoin[])=>
      {
        console.log(data);
    ...
    {
      this._candidateser.GetDirRejectedCandi().subscribe(
        (data:CandidateJoin[])=>
        {
          console.log(data);
          this.candidatejoinarr=data;
